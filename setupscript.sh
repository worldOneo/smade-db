...
cd smade-db
../zig-linux-x86_64-0.11.0/zig build-exe -O ReleaseSafe -mcpu native ./src/main.zig
../zig-linux-x86_64-0.11.0/zig build-exe -O ReleaseFast -mcpu native ./src/loader.zig
